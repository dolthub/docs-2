      ...
      },
      {
        ...
        children: [
          { title: "Data Sharing", href: "/products/dolthub/data-sharing" },
          {
            ...
            children: [
              { title: "Authentication", href: "/products/dolthub/api/authentication" },
              { title: "SQL", href: "/products/dolthub/api/sql" },
              { title: "CSV", href: "/products/dolthub/api/csv" },
              { title: "Databases", href: "/products/dolthub/api/databases" },
              { title: "Branches", href: "/products/dolthub/api/branches" },
              { title: "Pull Requests", href: "/products/dolthub/api/pull-requests" },
              { title: "Releases", href: "/products/dolthub/api/releases" },
              { title: "Tags", href: "/products/dolthub/api/tags" },
              { title: "File Uploads", href: "/products/dolthub/api/uploads" },
              { title: "Jobs", href: "/products/dolthub/api/jobs" },
