...
In this section of the documentation, we will explain [Git](./dolt/git/), [SQL](./dolt/sql/), and [Relational Database Management System (RDBMS)](./dolt/rdbms/) concepts and how we applied them in Dolt using the above axioms.