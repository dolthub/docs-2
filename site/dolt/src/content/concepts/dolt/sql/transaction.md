...
Note, you can make every transaction `COMMIT` a Dolt commit by setting the [system variable](./system-variables), [`@@dolt_transaction_commit`]../../../sql-reference/version-control/dolt-sysvars#dolt_transaction_commit)
