...
Dolt adopts the Git-interface to version control. There are [commits](./commits), [branches](./branch), [merges](./merge), and all the other Git concepts you are familiar with. If you know Git, Dolt will feel very familiar because conceptually, Dolt is modeled on Git.
