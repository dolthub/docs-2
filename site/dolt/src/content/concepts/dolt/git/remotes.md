...
DoltHub is a hosted Dolt remote with an additional discovery and management user interface. [DoltLab](https://www.dolthub.com/blog/2022-01-14-announcing-doltlab/) is a self-hosted version of DoltHub. [Dolt also supports filesystem, SSH, HTTPS, AWS, and GCS remotes](../../../reference/sql/version-control/remotes.md).
...
For example, you can use GitHub via SSH (`git@github.com:ORG/REPO.git`) or HTTPS (`https://github.com/ORG/REPO.git`). For detailed examples, see [Using remotes → Git remotes](../../../reference/sql/version-control/remotes.md#git-remotes).
