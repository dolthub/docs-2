...
API tokens can be used to authenticate calls to the CSV API over Basic [Authentication](authentication). This is useful for downloading data from private databases.
