...
columns. Columns can be [primary keys](/concepts/sql/primary-key) which act as a unique identifier for each
...
key [constraints](/concepts/sql/constraints). Use `CREATE` statements to create tables and `ALTER` statements
