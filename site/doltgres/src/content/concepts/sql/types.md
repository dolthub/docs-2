...
Types act as built in [constraints](/concepts/sql/constraints) to help define the shape of your data. Are you
...
Doltgres supports [most Postgres types](/reference/sql-support/supported-types), with more
being implemented.
