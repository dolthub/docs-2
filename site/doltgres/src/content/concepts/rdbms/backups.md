...
Using a [remote](/concepts/git/remotes) for backup allows you to back up all committed changes. You add
a remote using the [`select dolt_remote()`
function](/reference/version-control/dolt-sql-functions#dolt_remote). Then you push a
