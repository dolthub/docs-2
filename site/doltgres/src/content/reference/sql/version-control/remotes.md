...
procedure](/reference/sql/version-control/dolt-sql-functions#dolt_remote). You configure a remote with a name and a
...
Sync functionality is supported via the [`clone`](/reference/sql/version-control/dolt-sql-functions#dolt_clone),
[`fetch`](/reference/sql/version-control/dolt-sql-functions#dolt_fetch), [`push`](/reference/sql/version-control/dolt-sql-functions#dolt_push), and
[`pull`](/reference/sql/version-control/dolt-sql-functions#dolt_pull) procedures.
