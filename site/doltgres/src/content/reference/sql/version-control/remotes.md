...
database](/concepts/git/remotes). A remote is a copy of your database that is
...
description of remotes can be found [here](/concepts/git/remotes).

## Configuring Remotes

Remotes are configured using the [`dolt_remote`
procedure](https://dolthub.com/docs/sql-reference/version-control/dolt-sql-procedures#dolt_remote). You configure a remote with a name and a
...
this example, we'll use the running Doltgres server we created in the [Getting Started](/concepts/rdbms/) section to push a branch a file-based remote.
...
Sync functionality is supported via the [`clone`](https://dolthub.com/docs/sql-reference/version-control/dolt-sql-procedures#dolt_clone),
[`fetch`](https://dolthub.com/docs/sql-reference/version-control/dolt-sql-procedures#dolt_fetch), [`push`](https://dolthub.com/docs/sql-reference/version-control/dolt-sql-procedures#dolt_push), and
[`pull`](https://dolthub.com/docs/sql-reference/version-control/dolt-sql-procedures#dolt_pull) procedures.
