...
const SITE = "doltgres";
const SITE_TITLE = "Doltgres Documentation";
const SITE_BLURB =
  "Doltgres is a Postgres-compatible version-controlled database. It pairs Dolt's branches, diffs, merges, and pull requests with the Postgres wire protocol and SQL dialect, so Postgres clients can talk to a fully versioned database without changes.";
