...
// e.g. /docs/reference/server/configuration.md mirrors /docs/reference/server/configuration.
// LLM agents and other non-HTML consumers can fetch the .md suffix and skip
// the HTML parse. Same content file, same route slug (contentRouteSlug), so
// the two URLs always refer to the same source.
